...
<a name='glos_adaptive_flushing'></a>
...
<a name='glos_adaptive_hash_index'></a>
...
<a name='glos_application_programming_interface'></a>
...
<a name='glos_auto_increment_locking'></a>
...
<a name='glos_buffer_pool_instance'></a>
...
<a name='glos_change_buffering'></a>
...
<a name='glos_column_index'></a>
### column index 单列索引
在单列上加的索引(***index***)。

参见 [composite index], [index].

<a name='glos_column_prefix'></a>
### column prefix: 列的前缀
...
<a name='glos_compact_row_format'></a>
...
<a name='glos_composite_index'></a>
### composite index: 复合索引
包含多列的索引。

参见 [index], [index prefix].

<a name='glos_compressed_backup'></a>
...
<a name='glos_compressed_row_format'></a>
...
<a name='glos_compression_failure'></a>
...
<a name='glos_concatenated_index'></a>
### concatenated index: 复合索引
参考 [composite index].

<a name='glos_concurrency'></a>
### concurrency: 并发
...
<a name='glos_configuration_file'></a>
...
<a name='glos_data_definition_language'></a>
### data definition language: DDL

参见 [DDL].

<a name='glos_data_dictionary'></a>
...
<a name='glos_data_manipulation_language'></a>
### data manipulation language: DML

参见 [DML]。

<a name='glos_data_warehouse'></a>
### data warehouse: DW或数据仓库
...
<a name='glos_delete_buffering'></a>
### delete buffering 删除缓冲技术。
...
<a name='glos_descending_index'></a>
...
<a name='glos_doublewrite_buffer'></a>
...
<a name='glos_dynamic_row_format'></a>
...
<a name='glos_fast_index_creation'></a>
...
<a name='glos_fixed_row_format'></a>
...
<a name='glos_foreign_key_constraint'></a>
...
<a name='glos_fuzzy_checkpointing'></a>
...
<a name="glos_general_log"></a>
### general log: 数据库日志

参见 [general query log].

<a name="glos_general_query_log"></a>
### general query log: 数据库日志
...
<a name="glos_global_transaction"></a>
...
## <a name="I"></a>I ##
<a name="glos_io_bod"></a>
### I/O-bound: I/O带宽
参见[disk-bound]

<a name="glos_ib_file_set"></a>
### ib-file set: ib文件集
...
<a name="glos_ib_logfile"></a>
### ib_logfile: redolog文件或不译
...
<a name="glos_ibbackup_logfile"></a>
### ibbackup_logfile: 不译
...
<a name="glos_implicit_row_lock"></a>
### implicit row lock: 隐式行锁
一个为了确保数据一致性的InnoDB的行级锁，你不需要特别地请求它。

参见 [row lock].

<a name="glos_in_memory_database"></a>
...
<a name="glos_incremental_backup"></a>
...
<a name="glos_information_schema"></a>
...
<a name="glos_innodb_autoinc_lock_mode"></a>
...
<a name="glos_innodb_file_format"></a>
...
<a name="glos_innodb_file_per_table"></a>
...
<a name="glos_innodb_lock_wait_timeout"></a>
...
<a name="glos_innodb_strict_mode"></a>
...
<a name="glos_intention_exclusive_lock"></a>
### intention exclusive lock: 意向排它锁
参见 [intention lock].

<a name="glos_intention_lock"></a>
### intention lock 意向锁
...
<a name="glos_intention_shared_lock"></a>
### intention shared lock: 意向共享锁
参见 [intention lock].

<a name="glos_intention_inverted_index"></a>
### inverted index: 倒排索引
...
<a name="glos_midpoint_insertion_strategy"></a>
### midpoint insertion strategy: 中间插入策略
...
<a name="glos_mini_transaction"></a>
...
<a name="glos_mixed_mode_insert"></a>
...
<a name="glos_multi_core"></a>
### multi-core: 多核
可以利用多线程程序(如MySQL服务)优势的一种处理器。

<a name="glos_multiversion_concurrency_control"></a>
...
<a name="glos_mysql_enterprise_backup"></a>
...
<a name="glos_mysqlbackup_command"></a>
...
<a name="glos_non_repeatable_read"></a>
...
<a name="glos_not_null_constraint"></a>
...
<a name="glos_point_in_time_recovery"></a>
...
<a name="glos_prefix"></a>
### prefix: 前缀

参见 [index prefix].

<a name="glos_prepared_backup"></a>
...
<a name="glos_query_execution_plan"></a>
...
<a name="glos_query_log"></a>
### query log 查询日志

参见 [general query log].

<a name="glos_quiesce"></a>
### quiesce: 系统静默状态
...
<a name="glos_read_uncommitted"></a>
...
<a name="glos_read_only_transaction"></a>
...
<a name="glos_redundant_row_format"></a>
...
<a name="glos_referential_integrity"></a>
...
<a name="glos_rollback_segment"></a>
...
<a name="glos_row_based_replication"></a>
...
<a name="glos_row_level_locking"></a>
...
<a name="glos_semi_consistent_read"></a>
...
<a name="glos_surrogate_key"></a>
### surrogate key: 代理键
人造键(***synthetic key***)的别称。

参见 [synthetic key].

<a name="glos_synthetic_key"></a>
### synthetic key: 人造键
...
<a name="glos_system_tablespace"></a>
...
<a name="glos_table_scan"></a>
### table scan: 全表扫描

参见 [full table scan].

<a name="glos_table_statistics"></a>
...
<a name="glos_tablespace_dictionary"></a>
...
<a name="glos_temporary_tablespace"></a>
...
<a name="glos_troubleshooting"></a>
### troubleshooting: 故障排除
InnoDB可靠性与性能故障排除的资源包括：Information Schema表。

<a name="glos_truncate"></a>
### truncate: 删节
...
<a name="glos_two_phase_commit"></a>
...
<a name="glos_undo_buffer"></a>
### undo buffer: undo缓冲，不译

参见 [undo log].

<a name="glos_undo_log"></a>
### undo log: undo 日志，不译
...
<a name="glos_unique_constraint"></a>
...
## <a name="Y"></a>Y ##
<a name="glos_young_innodb_buffer_pool"></a>
### young InnoDB Buffer Pool: young InnoDB Buffer Pool
